...
var _mediaPreview = _interopRequireDefault(require('@reamey/media-preview'));
...
var SortMediaUpload = function SortMediaUpload(_ref, ref) {
    ...
    function () {
      return {
        ...
        onStart: function onStart(file) {
          ...
          fileListRef.current = (0, _utils.updateFileList)(
            targetItem,
            fileListRef.current,
          );
          forceUpdate();
  ...
  var onDragOver = (0, _react.useCallback)(
    function (e) {
      e.preventDefault();
  ...
  var onDragLeave = (0, _react.useCallback)(
    /*#__PURE__*/ (function () {
  ...
  return /*#__PURE__*/ _react.default.createElement(
    ...
    !!previewInfo &&
      /*#__PURE__*/ _react.default.createElement(_mediaPreview.default, {
        autoPlay: true,

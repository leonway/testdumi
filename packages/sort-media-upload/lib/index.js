...
var _useUpdate = _interopRequireDefault(require("ahooks/es/useUpdate"));

var constants = _interopRequireWildcard(require("./constant"));

var _axios = _interopRequireDefault(require("axios"));

var _mediaPreview = _interopRequireDefault(require("@sky/media-preview"));
...
var SortMediaUpload = function SortMediaUpload(_ref, ref) {
  var value = _ref.value,
      ...
      accepts = _ref$accepts === void 0 ? constants.DEFAULT_ACCEPTS : _ref$accepts,
      _ref$needSort = _ref.needSort,
      needSort = _ref$needSort === void 0 ? constants.DEFAULT_NEED_SORT : _ref$needSort,
      _ref$needCheckImgRati = _ref.needCheckImgRatio,
      needCheckImgRatio = _ref$needCheckImgRati === void 0 ? constants.DEFAULT_NEED_CHECK_IMG_RATIO : _ref$needCheckImgRati;
  var dragBoxRef = (0, _react.useRef)();
  var requestsRef = (0, _react.useRef)({});
  var forceUpdate = (0, _useUpdate.default)();
  ...
  var val2RcFiles = function val2RcFiles(arr) {
    return (arr || []).map(function (ossFile, i) {
      ...
      var startIndex = fileUrl === null || fileUrl === void 0 ? void 0 : fileUrl.lastIndexOf('/');
      var queryIndex = fileUrl === null || fileUrl === void 0 ? void 0 : fileUrl.lastIndexOf('?');
      var fileName = fileUrl === null || fileUrl === void 0 ? void 0 : fileUrl.slice(startIndex, queryIndex === -1 ? fileUrl.length : queryIndex); // const suffix = fileName.slice(fileName.lastIndexOf('.'), fileName.length)

      return {
        name: fileName,
        url: fileUrl,
        status: 'uploaded',
        uid: (0, _utils.getUid)(i),
        ossFile: ossFile
      };
    });
  }; // 处理value 回现
  ...
  var fileListRef = (0, _react.useRef)(val2RcFiles(value));
  (0, _react.useEffect)(function () {
    if (value instanceof Array) {
      ...
      if (newVals.length) {
        ...
        fileListRef.current = [].concat(_toConsumableArray(news), _toConsumableArray(fileListRef.current));
        forceUpdate();
      }
    }
  }, [value]);
  ...
  var fileList2Value = function fileList2Value() {
    return fileListRef.current.filter(function (item) {
  ...
  var onFileChange = function onFileChange(type, file) {
    if (['success', 'sort'].includes(type) || type === 'remove' && (file === null || file === void 0 ? void 0 : file.status) === 'uploaded') {
  ...
  var props = (0, _react.useMemo)(function () {
    return {
                  ...
                  case 0:
                    ...
                    return request(action, {
                      ...
                      onUploadProgress: function onUploadProgress(e) {
                        ...
                        if (e) {
                          var percent = parseInt(String(e.loaded / e.total * 100)); // console.log('percent', percent, e.loaded, e.total);
      ...
      beforeUpload: function beforeUpload(file, files) {
        ...
        var suffix = '.' + (file === null || file === void 0 ? void 0 : (_file$name = file.name) === null || _file$name === void 0 ? void 0 : (_file$name$split = _file$name.split('.')) === null || _file$name$split === void 0 ? void 0 : (_file$name$split$pop = _file$name$split.pop()) === null || _file$name$split$pop === void 0 ? void 0 : _file$name$split$pop.toLowerCase());
        var isRightType = accepts.includes(suffix);
        var totalFiles = [].concat(_toConsumableArray(files), _toConsumableArray(fileListRef.current));
        var totalNumber = totalFiles.length;
        var size = file.size / 1024 / 1024;

        if (totalNumber > limit) {
          (0, _utils.commonErrorMessage)("\u4E0A\u4F20\u6587\u4EF6\u7684\u6570\u91CF\u9650\u5236\u4E3A\uFF1A".concat(limit));
          return Promise.reject();
        }

        if (!isRightType) {
          _antd.message.error("\u4E0A\u4F20\u6587\u4EF6\u7684\u7C7B\u578B\u9650\u5236\u4E3A\uFF1A".concat(accepts.join(',')));

          return Promise.reject();
        }

        if (size > 200) {
          _antd.message.error("\u5355\u4E2A\u4E0A\u4F20\u6587\u4EF6\u5927\u5C0F\u9650\u5236\u5728200M\u4EE5\u5185");
      ...
      onStart: function onStart(file) {
        ...
        fileListRef.current = (0, _utils.updateFileList)(targetItem, fileListRef.current);
        forceUpdate();
      },
      onSuccess: function onSuccess(result, file, xhr) {
        ...
        fileListRef.current = (0, _utils.updateFileList)(targetItem, fileListRef.current); // console.log('fileListRef.current', fileListRef.current);
  ...
  }, [accepts, limit, action]); // console.log('fileListRef.current', fileListRef.current);

  var setFileList = (0, _react.useCallback)(function (fileList) {
    fileListRef.current = fileList;
    forceUpdate();
    onFileChange('sort');
  }, []);
  var onRemove = (0, _react.useCallback)(function (file) {
    if (!(0, _utils.getFileItem)(file, fileListRef.current)) {
      return;
    }
    ...
    fileListRef.current = (0, _utils.removeFileItem)(file, fileListRef.current);
    forceUpdate();
  ...
  var onDragLeave = (0, _react.useCallback)( /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 3:
              ...
              if (isAllowed) {
                files = [];
                Array.prototype.forEach.call(originFileList, function (v, i) {
                  v.uid = (0, _utils.getUid)(i);
                  files.push(v);
                ...
                files.forEach(function (file) {
                  if (file instanceof File) {
                    props.customRequest(_objectSpread(_objectSpread({}, props), {}, {
                      file: file
                    }));
                  }
                });
              } else {
                _antd.message.error("\u4E0A\u4F20\u6587\u4EF6\u7684\u6570\u91CF\u9650\u5236\u4E3A\uFF1A".concat(limit)); // dragBoxRef.current.style.borderColor = 'red'
  ...
  var onPreview = (0, _react.useCallback)(function (url, name) {
  ...
  }, !!previewInfo && /*#__PURE__*/_react.default.createElement(_mediaPreview.default, {
    autoPlay: true,
  ...
  }, fileListRef.current && currentLength ? /*#__PURE__*/_react.default.createElement(_FileList.default, {
    needSort: needSort,
  ...
  }, !currentLength && /*#__PURE__*/_react.default.createElement("span", null, "\u62D6\u62FD\u6587\u4EF6\u5230\u8FD9\u91CC\uFF0C\u6216\u8005"), /*#__PURE__*/_react.default.createElement(_rcUpload.default, _objectSpread({}, props), shouldHasButton && /*#__PURE__*/_react.default.createElement(_antd.Button, {
    type: "primary"
  }, fileListRef.current.length ? '继续上传' : '上传文件')), fileListRef.current && currentLength ? /*#__PURE__*/_react.default.createElement(_antd.Button, {
    style: {
      width: '84px'
    },
    onClick: reset
...
var _default = /*#__PURE__*/(0, _react.forwardRef)(SortMediaUpload);

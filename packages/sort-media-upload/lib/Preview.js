...
var _previewPlay = _interopRequireDefault(require("./assets/actions/previewPlay.svg"));

var _priviewVideo = _interopRequireDefault(require("./assets/png/priviewVideo.png"));

var _audioPreview = _interopRequireDefault(require("./assets/png/audioPreview.png"));

var _warning = _interopRequireDefault(require("./assets/png/warning.svg"));
...
var Preview = function Preview(_ref) {
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              _context3.prev = 0;
              _context3.next = 3;
              return (0, _utils.parseVideo)(isLocalVideo ? originFileObj : url);
  ...
  return /*#__PURE__*/_react.default.createElement("div", {
  ...
  }, isImg && previewUrl && /*#__PURE__*/_react.default.createElement("div", {
  ...
  }), needCheckImgRatio && info && info.width && info.height && info.width / info.height !== 16 / 9 ? /*#__PURE__*/_react.default.createElement(_antd.Tooltip, {
    title: '长宽比例不合规则'
  }, /*#__PURE__*/_react.default.createElement(_icons.default, {
    component: _warning.default,
    className: 'sort-media-preview-warning-icon'
  })) : null, isVideo && /*#__PURE__*/_react.default.createElement("img", {
    className: 'sort-media-preview-preview-url',
    src: _priviewVideo.default
  }), isAudio && /*#__PURE__*/_react.default.createElement("img", {
    className: "sort-media-preview-preview-url",
  ...
  }), status === 'uploaded' && (isImg || isAudio || isVideo) && /*#__PURE__*/_react.default.createElement(_icons.default, {
    component: isImg ? _preview.default : _previewPlay.default,
    onClick: function onClick() {
      onPreview(url, name);
    },
    className: 'sort-media-preview-preview-icon'
  }), status === 'uploaded' && needSort && /*#__PURE__*/_react.default.createElement("div", {
    className: (0, _classnames.default)('sort-media-preview-misk', 'sort-media-preview-drag-box')
  }, ' ', /*#__PURE__*/_react.default.createElement(_icons.default, {
    component: _move.default,
    className: 'sort-media-preview-drag-icon'
  }), "\u62D6\u62FD\u6392\u5E8F"), status === 'uploading' && /*#__PURE__*/_react.default.createElement("div", {
    className: (0, _classnames.default)('sort-media-preview-progress-box', 'sort-media-preview-misk')
  }, /*#__PURE__*/_react.default.createElement("span", null, "\u4E0A\u4F20\u4E2D"), /*#__PURE__*/_react.default.createElement(_antd.Progress, {
    ...
    className: (0, _classnames.default)('sort-media-preview-fail-box', 'sort-media-preview-misk')
  }, /*#__PURE__*/_react.default.createElement("span", null, "\u4E0A\u4F20\u5931\u8D25"), /*#__PURE__*/_react.default.createElement(_antd.Button, {
    onClick: function onClick() {

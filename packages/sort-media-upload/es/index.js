...
import { getFileItem, updateFileList, file2Obj, removeFileItem, getUid, commonErrorMessage } from './utils';
...
var SortMediaUpload = function SortMediaUpload(_ref, ref) {
    ...
    return {
      ...
      beforeUpload: function beforeUpload(file, files) {
        ...
        if (totalNumber > limit) {
          commonErrorMessage("\u4E0A\u4F20\u6587\u4EF6\u7684\u6570\u91CF\u9650\u5236\u4E3A\uFF1A".concat(limit));
          return Promise.reject();
        }

        if (!isRightType) {
          _message.error("\u4E0A\u4F20\u6587\u4EF6\u7684\u7C7B\u578B\u9650\u5236\u4E3A\uFF1A".concat(accepts.join(',')));

          return Promise.reject();
        }

        if (size > 200) {
          _message.error("\u5355\u4E2A\u4E0A\u4F20\u6587\u4EF6\u5927\u5C0F\u9650\u5236\u5728200M\u4EE5\u5185");
  ...
  var onDragLeave = useCallback( /*#__PURE__*/function () {
          ...
          switch (_context3.prev = _context3.next) {
            ...
            case 3:
              ...
              if (isAllowed) {
                ...
                _message.error("\u4E0A\u4F20\u6587\u4EF6\u7684\u6570\u91CF\u9650\u5236\u4E3A\uFF1A".concat(limit)); // dragBoxRef.current.style.borderColor = 'red'
  ...
  }, !!previewInfo && /*#__PURE__*/React.createElement(MediaPreview, {
    autoPlay: true,
  ...
  }, fileListRef.current && currentLength ? /*#__PURE__*/React.createElement(FileList, {
    needSort: needSort,
  ...
  }, !currentLength && /*#__PURE__*/React.createElement("span", null, "\u62D6\u62FD\u6587\u4EF6\u5230\u8FD9\u91CC\uFF0C\u6216\u8005"), /*#__PURE__*/React.createElement(Upload, _objectSpread({}, props), shouldHasButton && /*#__PURE__*/React.createElement(_Button, {
    type: "primary"
  }, fileListRef.current.length ? '继续上传' : '上传文件')), fileListRef.current && currentLength ? /*#__PURE__*/React.createElement(_Button, {
    style: {
      width: '84px'
    },
    onClick: reset

...
export var commonErrorMessage = function commonErrorMessage(msg) {
  _message.error({
    content: msg,
...
export var parseVideo = function parseVideo(data) {
...
export var parseOnlineImage = function parseOnlineImage(url) {
  return new Promise(function (res) {
    var img = new Image();
...
export var parseLocalImage = function parseLocalImage(file) {
